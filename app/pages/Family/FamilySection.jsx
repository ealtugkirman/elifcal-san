    ...
    <div className="section space-x-12 px-12 flex-row">
      <div className="w-1/2 space-y-12">
        <h1 className="secondheader italic">
          <span className="text-mainblue" >Ailenizin Refahı</span> için sizinle olmaya hazırız
        </h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti et
          maiores eveniet nostrum voluptatem modi vero provident officiis iure
          odit veniam distinctio consequatur voluptates laborum explicabo ut,
          placeat ea, dolorum in. Excepturi, itaque fugiat delectus ratione
          voluptatem est ipsa iure.
        </p>
